...
load("//tools/workspace/libzippp_internal:repository.bzl", "libzippp_internal_repository")  # noqa
...
def _add_internal_repositories():
    ...
    libzippp_internal_repository(name = "libzippp_internal", mirrors = mirrors)
