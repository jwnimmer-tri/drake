...
class TestWorkspaceBzlmodSync(unittest.TestCase):
    ...
    def _module_name_to_repo_name(self, module_name):
        """Some of our repository rules have a different name than.
        """
    ...
    def test_default_exclude_sync(self):
        ...
        # Don't check repositories that are irrelevant for bzlmod.
    ...
    def _canonicalize_workspace(self, content):
        ...
        for line in content.splitlines():
            ...
            if "apple_cc_configure" in line:
                # The configure function is non-bzlmod only.
                continue
