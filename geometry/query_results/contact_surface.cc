...
// TODO(SeanCurtis-TRI) Copy assignment and both constructors
...
template ContactSurface<Expression>::ContactSurface(
    const ContactSurface<Expression>&);

template ContactSurface<Expression>& ContactSurface<Expression>::operator=(
    const ContactSurface<Expression>& surface);
