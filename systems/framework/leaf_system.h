...
class LeafSystem : public System<T> {
 ...
 protected:
  ...
  DRAKE_DEPRECATED("2021-10-01", "Use DeclarePeriodicPublishEvent.")
  /** Declares a periodic publish event that invokes the
  ...
  DRAKE_DEPRECATED("2021-10-01", "Use DeclarePeriodicDiscreteUpdateEvent.")
  /** Declares a periodic discrete update event that invokes
  ...
  DRAKE_DEPRECATED("2021-10-01", "Use DeclarePeriodicUnrestrictedUpdateEvent.")
  /** Declares a periodic unrestricted update event that
  ...
  /** (Deprecated.) See the nearly identical signature with an additional
  (first) argument specifying the port name. */
  template <class MySystem, typename BasicVectorSubtype>
  DRAKE_DEPRECATED("2021-10-01", "Pass a port name as the first argument now.")
  LeafOutputPort<T>& DeclareVectorOutputPort(
      const BasicVectorSubtype& model_vector,
